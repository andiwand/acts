...
BOOST_AUTO_TEST_CASE(step_extension_vacuum_test) {
  ...
  const CurvilinearTrackParameters sbtp(Vector3::Zero(), startDir, 1_e / 1_GeV,
                                        cov, ParticleHypothesis::pion());
...
BOOST_AUTO_TEST_CASE(step_extension_material_test) {
  ...
  const CurvilinearTrackParameters sbtp(Vector3::Zero(), startDir, 1_e / 5_GeV,
                                        cov, ParticleHypothesis::pion());
...
BOOST_AUTO_TEST_CASE(step_extension_vacmatvac_test) {
  ...
  // Set initial parameters for the particle track
  CurvilinearTrackParameters sbtp(Vector3::Zero(), 0_degree, 90_degree,
