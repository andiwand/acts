 ...
 private:
  ...
  class Actor {
   public:
    ...
    void operator()(result_type& result, propagator_state_t& state, const stepper_t& stepper,
  ...
  class Aborter {
   public:
    ...
    bool operator()(const result_t& result, propagator_state_t& /*state*/, const stepper_t& /*stepper*/,
                    const navigator_t& /*navigator*/, const Logger& /*logger*/) const {
