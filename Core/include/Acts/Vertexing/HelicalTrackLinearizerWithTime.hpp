...
/// @class HelicalTrackLinearizerWithTime
...
class HelicalTrackLinearizerWithTime {
 public:
  ...
  HelicalTrackLinearizerWithTime(const Config& config,
  ...
  Result<LinearizedTrack> linearizeTrack(const BoundTrackParameters& params,
                                         ...
                                         State& state) const;
  void calculateNumericalJacobians(const BoundTrackParameters& params,
                                   const Vector4& linPoint,
                                   const Acts::GeometryContext& gctx,
                                   const Acts::MagneticFieldContext& mctx,
                                   State& state) const;
...
#include "HelicalTrackLinearizerWithTime.ipp"
