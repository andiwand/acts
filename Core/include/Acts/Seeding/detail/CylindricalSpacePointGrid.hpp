...
class CylindricalSpacePointGridCreator {
 public:
  static CylindricalSpacePointGrid createGrid(
      const CylindricalSpacePointGridConfig& _config,
      const CylindricalSpacePointGridOptions& _options,
      const Logger& logger = getDummyLogger());

  template <typename spacepoint_iterator_t>
  static void fillGrid(const SeedFinderConfig& config,
                       CylindricalSpacePointGrid& grid,
                       const SpacePointContainer& collection,
