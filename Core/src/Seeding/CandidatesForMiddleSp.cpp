...
void CandidatesForMiddleSp::setMaxElements(std::size_t nLow,
                                           std::size_t nHigh) {
  m_maxSizeHigh = nHigh;
  m_maxSizeLow = nLow;
...
void CandidatesForMiddleSp::pop(std::vector<std::size_t>& indices,
...
bool CandidatesForMiddleSp::exists(const std::size_t n,
...
float CandidatesForMiddleSp::weight(const std::vector<std::size_t>& indices,
                                    std::size_t n) const {
  // Get the weight of the n-th element
  return m_storage[indices[n]].weight;
}

void CandidatesForMiddleSp::clear() {
...
void CandidatesForMiddleSp::addToCollection(std::vector<std::size_t>& indices,
                                            ...
                                            const TripletCandidate& element) {
...
std::vector<TripletCandidate> CandidatesForMiddleSp::storage(
  ...
  while (m_nHigh != 0 || m_nLow != 0) {
    ...
    if (descendingByQuality(spacePointContainer, m_storage[m_indicesLow[0]],
...
bool CandidatesForMiddleSp::descendingByQuality(
    const SpacePointContainer& spacePointContainer, const TripletCandidate& i1,
  ...
  auto bottomL1 = spacePointContainer.at(i1.bottom);
  auto middleL1 = spacePointContainer.at(i1.middle);
  auto topL1 = spacePointContainer.at(i1.top);

  auto bottomL2 = spacePointContainer.at(i2.bottom);
  auto middleL2 = spacePointContainer.at(i2.middle);
  auto topL2 = spacePointContainer.at(i2.top);
