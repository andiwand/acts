...
class Hit {
 public:
  ...
  /// @param particleHitIndex_ Hit index along the particle trajectory
  ///
  ...
  Hit(Acts::GeometryIdentifier geometryId, Barcode particleId,
      ...
      const Acts::Vector4& after4, std::int32_t particleHitIndex_ = -1)
      : m_geometryId(geometryId),
        m_particleId(particleId),
        m_particleHitIndex(particleHitIndex_),
        m_pos4(pos4),
        m_before4(before4),
        m_after4(after4) {}
  ...
  /// @return Index of the particle in the particle container
  constexpr ParticleIndex particleIndex() const { return m_particleIndex; }
 ...
 private:
  ...
  /// Index of the particle in the particle container.
  ParticleIndex m_particleIndex = 0;
