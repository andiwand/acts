...
ProcessCode VertexPerformanceWriter::writeT(
  ...
  for (const auto& [vtxIndex, vtx] : Acts::enumerate(vertices)) {
    ...
    Acts::ActsScalar varX = vtx.covariance()(Acts::CoordinateIndices::eX,
                                             Acts::CoordinateIndices::eX);
    Acts::ActsScalar varY = vtx.covariance()(Acts::CoordinateIndices::eY,
                                             Acts::CoordinateIndices::eY);
    Acts::ActsScalar varZ = vtx.covariance()(Acts::CoordinateIndices::eZ,
