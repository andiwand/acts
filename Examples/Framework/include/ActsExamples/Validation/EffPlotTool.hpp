 ...
 public:
  ...
  struct Config {
    ...
    std::map<std::string, AxisVariant> varBinning = {
        ...
        {"Phi", BoostRegularAxis(100, -std::numbers::pi, std::numbers::pi,
                                 "truth #phi")},
        {"Pt", BoostRegularAxis(40, 0, 100, "truth p_{T} [GeV/c]")},
        {"LogPt", BoostLogAxis(11, 0.1, 100, "truth p_{T} [GeV/c]")},
        {"LowPt", BoostRegularAxis(40, 0, 2, "truth p_{T} [GeV/c]")},
        {"D0", BoostRegularAxis(200, -200, 200, "truth d_{0} [mm]")},
        {"Z0", BoostRegularAxis(50, -200, 200, "truth z_{0} [mm]")},
        {"DeltaR", BoostRegularAxis(100, 0, 0.3, "truth #Delta R")},
        {"prodR", BoostRegularAxis(100, 0, 200, "truth R_{prod} [mm]")}};
